...
class Settings_model extends CI_Model
{
	...
	var $id;
	var $name = "";
	var $code = ""; // like "en" for language
	var $type =  ""; //category type {OS,License,language}
	var $url = ""; //category website description
	var $description="";
	 ...
	 */
	 public function add()
	 {
	 	$query = "insert into category 
	 			  ...
	 			  values
	 			  ('{$this->name}' , '{$this->code}' , '{$this->type}' , '{$this->url}' , '{$this->description}' , CURDATE() , 'F' ) 
	 				";	
		$this->db->query($query);
	 }
